...
public interface RoleJdgxbGxbRepository extends JpaRepository<RoleJdgxbGxb, String> {
	...
	public List<RoleJdgxbGxb> findByWjzlAndRoleIdIn(String wjzl, Collection<String> roles);
...
//	RoleJdgxbGxb findByFunctionName(String roleName);
	...
	public RoleJdgxbGxb findByJdIdAndAndRoleIdIn(String jdid, Collection<String> roles);
}
